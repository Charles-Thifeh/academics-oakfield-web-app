        ...
        <div class="max-w-7xl grid gap-x-8 md:grid-cols-3 mx-auto sm:px-6 lg:px-8">
            @if ($class != null)
                <div class="bg-green-700 flex my-4 mx-8 justify-between px-10 py-10 overflow-hidden shadow-sm sm:rounded-lg hover:scale-110 transition duration-300 ease-in-out">
                    ...
                    <a href="" class="bg-transparent h-12 w-28 hover:bg-white text-white font-semibold hover:text-green-700 py-2 px-4 border border-white hover:border-transparent rounded">
                        Click here
                    </a>
                </div>
            ...
            @if ($subjects->first() != null)
                ...
                <div class="bg-green-700 flex my-4 mx-8 justify-between px-10 py-10 overflow-hidden shadow-sm sm:rounded-lg hover:scale-110 transition duration-300 ease-in-out">
                    ...
                    <a href="{{ route('upload-index') }}" class="bg-transparent h-12 w-28 hover:bg-white text-white font-semibold hover:text-green-700 py-2 px-4 border border-white hover:border-transparent rounded">
                        Click here
                    </a>
                </div>
            ...
            @if (strpos($teacher_id, "ADMIN") !== false)
                ...
                <div class="bg-green-700 flex my-4 mx-8 justify-between px-10 py-10 overflow-hidden shadow-sm sm:rounded-lg hover:scale-110 transition duration-300 ease-in-out">
                    ...
                    <a href="{{ route('admin-teacher') }}" class="bg-transparent h-12 w-28 hover:bg-white text-white font-semibold hover:text-green-700 py-2 px-4 border border-white hover:border-transparent rounded">
                        Click here
                    </a>
                </div>
