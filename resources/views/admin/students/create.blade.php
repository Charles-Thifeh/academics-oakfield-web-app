    ...
    <style>
        ...
        <div class="container mx-auto">
            ...
            <div class="max-w-xl p-5 mx-auto my-10 bg-white rounded-md shadow-sm">
                ...
                <div>
                  <form class="mt-8" action="{{route('admin-student-store')}}" method="POST">
                      @csrf
                      <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative flex w-full">
                            <input name="reg_no" type="text" class="block w-full py-3 pl-4 pr-8 bg-white border border-gray-300 rounded-sm appearance-none cursor-pointer focus:outline-none hover:border-gray-400" placeholder="Reg No">
